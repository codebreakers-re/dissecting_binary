...
pub const Elf32_Ehdr = extern struct {
    e_ident: [16]u8 = @import("std").mem.zeroes([16]u8),
    e_type: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    e_machine: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    e_version: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    e_entry: Elf32_Addr = @import("std").mem.zeroes(Elf32_Addr),
    e_phoff: Elf32_Off = @import("std").mem.zeroes(Elf32_Off),
    e_shoff: Elf32_Off = @import("std").mem.zeroes(Elf32_Off),
    e_flags: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    e_ehsize: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    e_phentsize: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    e_phnum: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    e_shentsize: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    e_shnum: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    e_shstrndx: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
};
pub const Elf64_Ehdr = extern struct {
    e_ident: [16]u8 = @import("std").mem.zeroes([16]u8),
    e_type: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    e_machine: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    e_version: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    e_entry: Elf64_Addr = @import("std").mem.zeroes(Elf64_Addr),
    e_phoff: Elf64_Off = @import("std").mem.zeroes(Elf64_Off),
    e_shoff: Elf64_Off = @import("std").mem.zeroes(Elf64_Off),
    e_flags: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    e_ehsize: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    e_phentsize: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    e_phnum: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    e_shentsize: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    e_shnum: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    e_shstrndx: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
};
pub const Elf32_Shdr = extern struct {
    sh_name: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    sh_type: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    sh_flags: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    sh_addr: Elf32_Addr = @import("std").mem.zeroes(Elf32_Addr),
    sh_offset: Elf32_Off = @import("std").mem.zeroes(Elf32_Off),
    sh_size: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    sh_link: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    sh_info: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    sh_addralign: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    sh_entsize: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
};
pub const Elf64_Shdr = extern struct {
    sh_name: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    sh_type: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    sh_flags: Elf64_Xword = @import("std").mem.zeroes(Elf64_Xword),
    sh_addr: Elf64_Addr = @import("std").mem.zeroes(Elf64_Addr),
    sh_offset: Elf64_Off = @import("std").mem.zeroes(Elf64_Off),
    sh_size: Elf64_Xword = @import("std").mem.zeroes(Elf64_Xword),
    sh_link: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    sh_info: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    sh_addralign: Elf64_Xword = @import("std").mem.zeroes(Elf64_Xword),
    sh_entsize: Elf64_Xword = @import("std").mem.zeroes(Elf64_Xword),
};
pub const Elf32_Chdr = extern struct {
    ch_type: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    ch_size: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    ch_addralign: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
};
pub const Elf64_Chdr = extern struct {
    ch_type: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    ch_reserved: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    ch_size: Elf64_Xword = @import("std").mem.zeroes(Elf64_Xword),
    ch_addralign: Elf64_Xword = @import("std").mem.zeroes(Elf64_Xword),
};
pub const Elf32_Sym = extern struct {
    st_name: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    st_value: Elf32_Addr = @import("std").mem.zeroes(Elf32_Addr),
    st_size: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    st_info: u8 = @import("std").mem.zeroes(u8),
    st_other: u8 = @import("std").mem.zeroes(u8),
    st_shndx: Elf32_Section = @import("std").mem.zeroes(Elf32_Section),
};
pub const Elf64_Sym = extern struct {
    st_name: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    st_info: u8 = @import("std").mem.zeroes(u8),
    st_other: u8 = @import("std").mem.zeroes(u8),
    st_shndx: Elf64_Section = @import("std").mem.zeroes(Elf64_Section),
    st_value: Elf64_Addr = @import("std").mem.zeroes(Elf64_Addr),
    st_size: Elf64_Xword = @import("std").mem.zeroes(Elf64_Xword),
};
pub const Elf32_Syminfo = extern struct {
    si_boundto: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    si_flags: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
};
pub const Elf64_Syminfo = extern struct {
    si_boundto: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    si_flags: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
};
pub const Elf32_Rel = extern struct {
    r_offset: Elf32_Addr = @import("std").mem.zeroes(Elf32_Addr),
    r_info: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
};
pub const Elf64_Rel = extern struct {
    r_offset: Elf64_Addr = @import("std").mem.zeroes(Elf64_Addr),
    r_info: Elf64_Xword = @import("std").mem.zeroes(Elf64_Xword),
};
pub const Elf32_Rela = extern struct {
    r_offset: Elf32_Addr = @import("std").mem.zeroes(Elf32_Addr),
    r_info: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    r_addend: Elf32_Sword = @import("std").mem.zeroes(Elf32_Sword),
};
pub const Elf64_Rela = extern struct {
    r_offset: Elf64_Addr = @import("std").mem.zeroes(Elf64_Addr),
    r_info: Elf64_Xword = @import("std").mem.zeroes(Elf64_Xword),
    r_addend: Elf64_Sxword = @import("std").mem.zeroes(Elf64_Sxword),
};
pub const Elf32_Phdr = extern struct {
    p_type: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    p_offset: Elf32_Off = @import("std").mem.zeroes(Elf32_Off),
    p_vaddr: Elf32_Addr = @import("std").mem.zeroes(Elf32_Addr),
    p_paddr: Elf32_Addr = @import("std").mem.zeroes(Elf32_Addr),
    p_filesz: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    p_memsz: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    p_flags: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    p_align: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
};
pub const Elf64_Phdr = extern struct {
    p_type: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    p_flags: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    p_offset: Elf64_Off = @import("std").mem.zeroes(Elf64_Off),
    p_vaddr: Elf64_Addr = @import("std").mem.zeroes(Elf64_Addr),
    p_paddr: Elf64_Addr = @import("std").mem.zeroes(Elf64_Addr),
    p_filesz: Elf64_Xword = @import("std").mem.zeroes(Elf64_Xword),
    p_memsz: Elf64_Xword = @import("std").mem.zeroes(Elf64_Xword),
    p_align: Elf64_Xword = @import("std").mem.zeroes(Elf64_Xword),
};
...
pub const Elf32_Dyn = extern struct {
    d_tag: Elf32_Sword = @import("std").mem.zeroes(Elf32_Sword),
    d_un: union_unnamed_1 = @import("std").mem.zeroes(union_unnamed_1),
};
...
pub const Elf64_Dyn = extern struct {
    d_tag: Elf64_Sxword = @import("std").mem.zeroes(Elf64_Sxword),
    d_un: union_unnamed_2 = @import("std").mem.zeroes(union_unnamed_2),
};
pub const Elf32_Verdef = extern struct {
    vd_version: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    vd_flags: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    vd_ndx: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    vd_cnt: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    vd_hash: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    vd_aux: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    vd_next: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
};
pub const Elf64_Verdef = extern struct {
    vd_version: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    vd_flags: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    vd_ndx: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    vd_cnt: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    vd_hash: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    vd_aux: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    vd_next: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
};
pub const Elf32_Verdaux = extern struct {
    vda_name: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    vda_next: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
};
pub const Elf64_Verdaux = extern struct {
    vda_name: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    vda_next: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
};
pub const Elf32_Verneed = extern struct {
    vn_version: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    vn_cnt: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    vn_file: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    vn_aux: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    vn_next: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
};
pub const Elf64_Verneed = extern struct {
    vn_version: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    vn_cnt: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    vn_file: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    vn_aux: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    vn_next: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
};
pub const Elf32_Vernaux = extern struct {
    vna_hash: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    vna_flags: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    vna_other: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    vna_name: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    vna_next: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
};
pub const Elf64_Vernaux = extern struct {
    vna_hash: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    vna_flags: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    vna_other: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    vna_name: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    vna_next: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
};
const union_unnamed_3 = extern union {
    a_val: u32,
};
pub const Elf32_auxv_t = extern struct {
    a_type: u32 = @import("std").mem.zeroes(u32),
    a_un: union_unnamed_3 = @import("std").mem.zeroes(union_unnamed_3),
};
const union_unnamed_4 = extern union {
    a_val: u64,
};
pub const Elf64_auxv_t = extern struct {
    a_type: u64 = @import("std").mem.zeroes(u64),
    a_un: union_unnamed_4 = @import("std").mem.zeroes(union_unnamed_4),
};
pub const Elf32_Nhdr = extern struct {
    n_namesz: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    n_descsz: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    n_type: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
};
pub const Elf64_Nhdr = extern struct {
    n_namesz: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    n_descsz: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    n_type: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
};
pub const Elf32_Move = extern struct {
    m_value: Elf32_Xword = @import("std").mem.zeroes(Elf32_Xword),
    m_info: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    m_poffset: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    m_repeat: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    m_stride: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
};
pub const Elf64_Move = extern struct {
    m_value: Elf64_Xword = @import("std").mem.zeroes(Elf64_Xword),
    m_info: Elf64_Xword = @import("std").mem.zeroes(Elf64_Xword),
    m_poffset: Elf64_Xword = @import("std").mem.zeroes(Elf64_Xword),
    m_repeat: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
    m_stride: Elf64_Half = @import("std").mem.zeroes(Elf64_Half),
};
const struct_unnamed_5 = extern struct {
    gt_current_g_value: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    gt_unused: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
};
const struct_unnamed_6 = extern struct {
    gt_g_value: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    gt_bytes: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
};
...
pub const Elf32_RegInfo = extern struct {
    ri_gprmask: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    ri_cprmask: [4]Elf32_Word = @import("std").mem.zeroes([4]Elf32_Word),
    ri_gp_value: Elf32_Sword = @import("std").mem.zeroes(Elf32_Sword),
};
pub const Elf_Options = extern struct {
    kind: u8 = @import("std").mem.zeroes(u8),
    size: u8 = @import("std").mem.zeroes(u8),
    section: Elf32_Section = @import("std").mem.zeroes(Elf32_Section),
    info: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
};
pub const Elf_Options_Hw = extern struct {
    hwp_flags1: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    hwp_flags2: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
};
pub const Elf32_Lib = extern struct {
    l_name: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    l_time_stamp: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    l_checksum: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    l_version: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    l_flags: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
};
pub const Elf64_Lib = extern struct {
    l_name: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    l_time_stamp: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    l_checksum: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    l_version: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
    l_flags: Elf64_Word = @import("std").mem.zeroes(Elf64_Word),
};
pub const Elf32_Conflict = Elf32_Addr;
pub const Elf_MIPS_ABIFlags_v0 = extern struct {
    version: Elf32_Half = @import("std").mem.zeroes(Elf32_Half),
    isa_level: u8 = @import("std").mem.zeroes(u8),
    isa_rev: u8 = @import("std").mem.zeroes(u8),
    gpr_size: u8 = @import("std").mem.zeroes(u8),
    cpr1_size: u8 = @import("std").mem.zeroes(u8),
    cpr2_size: u8 = @import("std").mem.zeroes(u8),
    fp_abi: u8 = @import("std").mem.zeroes(u8),
    isa_ext: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    ases: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    flags1: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
    flags2: Elf32_Word = @import("std").mem.zeroes(Elf32_Word),
};
...
pub const ET_LOOS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xfe00, .hex);
pub const ET_HIOS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xfeff, .hex);
pub const ET_LOPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff00, .hex);
pub const ET_HIPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xffff, .hex);
...
pub const EM_ALPHA = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x9026, .hex);
pub const EV_NONE = @as(c_int, 0);
pub const EV_CURRENT = @as(c_int, 1);
pub const EV_NUM = @as(c_int, 2);
pub const SHN_UNDEF = @as(c_int, 0);
pub const SHN_LORESERVE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff00, .hex);
pub const SHN_LOPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff00, .hex);
pub const SHN_BEFORE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff00, .hex);
pub const SHN_AFTER = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff01, .hex);
pub const SHN_HIPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff1f, .hex);
pub const SHN_LOOS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff20, .hex);
pub const SHN_HIOS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff3f, .hex);
pub const SHN_ABS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xfff1, .hex);
pub const SHN_COMMON = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xfff2, .hex);
pub const SHN_XINDEX = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xffff, .hex);
pub const SHN_HIRESERVE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xffff, .hex);
...
pub const SHT_LOOS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x60000000, .hex);
pub const SHT_GNU_ATTRIBUTES = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffff5, .hex);
pub const SHT_GNU_HASH = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffff6, .hex);
pub const SHT_GNU_LIBLIST = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffff7, .hex);
pub const SHT_CHECKSUM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffff8, .hex);
pub const SHT_LOSUNW = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffffa, .hex);
pub const SHT_SUNW_move = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffffa, .hex);
pub const SHT_SUNW_COMDAT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffffb, .hex);
pub const SHT_SUNW_syminfo = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffffc, .hex);
pub const SHT_GNU_verdef = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffffd, .hex);
pub const SHT_GNU_verneed = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffffe, .hex);
pub const SHT_GNU_versym = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6fffffff, .hex);
pub const SHT_HISUNW = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6fffffff, .hex);
pub const SHT_HIOS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6fffffff, .hex);
pub const SHT_LOPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000000, .hex);
pub const SHT_HIPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7fffffff, .hex);
pub const SHT_LOUSER = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x80000000, .hex);
pub const SHT_HIUSER = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8fffffff, .hex);
...
pub const SHF_MASKOS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0ff00000, .hex);
pub const SHF_MASKPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xf0000000, .hex);
...
pub const ELFCOMPRESS_LOOS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x60000000, .hex);
pub const ELFCOMPRESS_HIOS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6fffffff, .hex);
pub const ELFCOMPRESS_LOPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000000, .hex);
pub const ELFCOMPRESS_HIPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7fffffff, .hex);
pub const GRP_COMDAT = @as(c_int, 0x1);
pub const SYMINFO_BT_SELF = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xffff, .hex);
pub const SYMINFO_BT_PARENT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xfffe, .hex);
pub const SYMINFO_BT_LOWRESERVE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff00, .hex);
...
pub inline fn ELF64_R_TYPE(i: anytype) @TypeOf(i & @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xffffffff, .hex)) {
    _ = &i;
    return i & @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xffffffff, .hex);
}
...
pub const PN_XNUM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xffff, .hex);
...
pub const PT_LOOS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x60000000, .hex);
pub const PT_GNU_EH_FRAME = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6474e550, .hex);
pub const PT_GNU_STACK = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6474e551, .hex);
pub const PT_GNU_RELRO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6474e552, .hex);
pub const PT_GNU_PROPERTY = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6474e553, .hex);
pub const PT_LOSUNW = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffffa, .hex);
pub const PT_SUNWBSS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffffa, .hex);
pub const PT_SUNWSTACK = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffffb, .hex);
pub const PT_HISUNW = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6fffffff, .hex);
pub const PT_HIOS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6fffffff, .hex);
pub const PT_LOPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000000, .hex);
pub const PT_HIPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7fffffff, .hex);
pub const PF_X = @as(c_int, 1) << @as(c_int, 0);
pub const PF_W = @as(c_int, 1) << @as(c_int, 1);
pub const PF_R = @as(c_int, 1) << @as(c_int, 2);
pub const PF_MASKOS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0ff00000, .hex);
pub const PF_MASKPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xf0000000, .hex);
...
pub const NT_SIGINFO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x53494749, .hex);
pub const NT_FILE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x46494c45, .hex);
pub const NT_PRXFPREG = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x46e62b7f, .hex);
...
pub const DT_LOOS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6000000d, .hex);
pub const DT_HIOS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffff000, .hex);
pub const DT_LOPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000000, .hex);
pub const DT_HIPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7fffffff, .hex);
pub const DT_PROCNUM = DT_MIPS_NUM;
pub const DT_VALRNGLO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffd00, .hex);
pub const DT_GNU_PRELINKED = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffdf5, .hex);
pub const DT_GNU_CONFLICTSZ = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffdf6, .hex);
pub const DT_GNU_LIBLISTSZ = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffdf7, .hex);
pub const DT_CHECKSUM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffdf8, .hex);
pub const DT_PLTPADSZ = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffdf9, .hex);
pub const DT_MOVEENT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffdfa, .hex);
pub const DT_MOVESZ = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffdfb, .hex);
pub const DT_FEATURE_1 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffdfc, .hex);
pub const DT_POSFLAG_1 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffdfd, .hex);
pub const DT_SYMINSZ = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffdfe, .hex);
pub const DT_SYMINENT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffdff, .hex);
pub const DT_VALRNGHI = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffdff, .hex);
pub inline fn DT_VALTAGIDX(tag: anytype) @TypeOf(DT_VALRNGHI - tag) {
    _ = &tag;
    return DT_VALRNGHI - tag;
}
pub const DT_VALNUM = @as(c_int, 12);
pub const DT_ADDRRNGLO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffe00, .hex);
pub const DT_GNU_HASH = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffef5, .hex);
pub const DT_TLSDESC_PLT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffef6, .hex);
pub const DT_TLSDESC_GOT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffef7, .hex);
pub const DT_GNU_CONFLICT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffef8, .hex);
pub const DT_GNU_LIBLIST = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffef9, .hex);
pub const DT_CONFIG = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffefa, .hex);
pub const DT_DEPAUDIT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffefb, .hex);
pub const DT_AUDIT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffefc, .hex);
pub const DT_PLTPAD = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffefd, .hex);
pub const DT_MOVETAB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffefe, .hex);
pub const DT_SYMINFO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffeff, .hex);
pub const DT_ADDRRNGHI = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffeff, .hex);
pub inline fn DT_ADDRTAGIDX(tag: anytype) @TypeOf(DT_ADDRRNGHI - tag) {
    _ = &tag;
    return DT_ADDRRNGHI - tag;
}
pub const DT_ADDRNUM = @as(c_int, 11);
pub const DT_VERSYM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffff0, .hex);
pub const DT_RELACOUNT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffff9, .hex);
pub const DT_RELCOUNT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffffa, .hex);
pub const DT_FLAGS_1 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffffb, .hex);
pub const DT_VERDEF = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffffc, .hex);
pub const DT_VERDEFNUM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffffd, .hex);
pub const DT_VERNEED = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6ffffffe, .hex);
pub const DT_VERNEEDNUM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x6fffffff, .hex);
...
pub const DT_AUXILIARY = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7ffffffd, .hex);
pub const DT_FILTER = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7fffffff, .hex);
...
pub const DF_1_DISPRELDNE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00008000, .hex);
pub const DF_1_DISPRELPND = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00010000, .hex);
pub const DF_1_NODIRECT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00020000, .hex);
pub const DF_1_IGNMULDEF = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00040000, .hex);
pub const DF_1_NOKSYMS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00080000, .hex);
pub const DF_1_NOHDR = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00100000, .hex);
pub const DF_1_EDITED = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00200000, .hex);
pub const DF_1_NORELOC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00400000, .hex);
pub const DF_1_SYMINTPOSE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00800000, .hex);
pub const DF_1_GLOBAUDIT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x01000000, .hex);
pub const DF_1_SINGLETON = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x02000000, .hex);
pub const DF_1_STUB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x04000000, .hex);
pub const DF_1_PIE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x08000000, .hex);
pub const DF_1_KMOD = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x10000000, .hex);
pub const DF_1_WEAKFILTER = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x20000000, .hex);
pub const DF_1_NOCOMMON = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x40000000, .hex);
...
pub const VER_NDX_LORESERVE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff00, .hex);
pub const VER_NDX_ELIMINATE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff01, .hex);
...
pub const NT_FDO_PACKAGING_METADATA = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xcafe1a7e, .hex);
...
pub const GNU_PROPERTY_UINT32_AND_LO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xb0000000, .hex);
pub const GNU_PROPERTY_UINT32_AND_HI = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xb0007fff, .hex);
pub const GNU_PROPERTY_UINT32_OR_LO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xb0008000, .hex);
pub const GNU_PROPERTY_UINT32_OR_HI = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xb000ffff, .hex);
pub const GNU_PROPERTY_1_NEEDED = GNU_PROPERTY_UINT32_OR_LO;
pub const GNU_PROPERTY_1_NEEDED_INDIRECT_EXTERN_ACCESS = @as(c_uint, 1) << @as(c_int, 0);
pub const GNU_PROPERTY_LOPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xc0000000, .hex);
pub const GNU_PROPERTY_HIPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xdfffffff, .hex);
pub const GNU_PROPERTY_LOUSER = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xe0000000, .hex);
pub const GNU_PROPERTY_HIUSER = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xffffffff, .hex);
pub const GNU_PROPERTY_AARCH64_FEATURE_1_AND = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xc0000000, .hex);
...
pub const GNU_PROPERTY_X86_ISA_1_USED = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xc0010002, .hex);
pub const GNU_PROPERTY_X86_ISA_1_NEEDED = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xc0008002, .hex);
pub const GNU_PROPERTY_X86_FEATURE_1_AND = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xc0000002, .hex);
...
pub const EF_CPU32 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00810000, .hex);
...
pub const EF_SPARC_LEDATA = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x800000, .hex);
pub const EF_SPARC_EXT_MASK = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xFFFF00, .hex);
...
pub const DT_SPARC_REGISTER = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000001, .hex);
...
pub const EF_MIPS_ARCH = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xf0000000, .hex);
pub const EF_MIPS_ARCH_1 = @as(c_int, 0x00000000);
pub const EF_MIPS_ARCH_2 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x10000000, .hex);
pub const EF_MIPS_ARCH_3 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x20000000, .hex);
pub const EF_MIPS_ARCH_4 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x30000000, .hex);
pub const EF_MIPS_ARCH_5 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x40000000, .hex);
pub const EF_MIPS_ARCH_32 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x50000000, .hex);
pub const EF_MIPS_ARCH_64 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x60000000, .hex);
pub const EF_MIPS_ARCH_32R2 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000000, .hex);
pub const EF_MIPS_ARCH_64R2 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x80000000, .hex);
...
pub const SHN_MIPS_ACOMMON = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff00, .hex);
pub const SHN_MIPS_TEXT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff01, .hex);
pub const SHN_MIPS_DATA = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff02, .hex);
pub const SHN_MIPS_SCOMMON = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff03, .hex);
pub const SHN_MIPS_SUNDEFINED = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff04, .hex);
pub const SHT_MIPS_LIBLIST = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000000, .hex);
pub const SHT_MIPS_MSYM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000001, .hex);
pub const SHT_MIPS_CONFLICT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000002, .hex);
pub const SHT_MIPS_GPTAB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000003, .hex);
pub const SHT_MIPS_UCODE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000004, .hex);
pub const SHT_MIPS_DEBUG = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000005, .hex);
pub const SHT_MIPS_REGINFO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000006, .hex);
pub const SHT_MIPS_PACKAGE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000007, .hex);
pub const SHT_MIPS_PACKSYM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000008, .hex);
pub const SHT_MIPS_RELD = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000009, .hex);
pub const SHT_MIPS_IFACE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000000b, .hex);
pub const SHT_MIPS_CONTENT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000000c, .hex);
pub const SHT_MIPS_OPTIONS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000000d, .hex);
pub const SHT_MIPS_SHDR = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000010, .hex);
pub const SHT_MIPS_FDESC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000011, .hex);
pub const SHT_MIPS_EXTSYM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000012, .hex);
pub const SHT_MIPS_DENSE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000013, .hex);
pub const SHT_MIPS_PDESC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000014, .hex);
pub const SHT_MIPS_LOCSYM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000015, .hex);
pub const SHT_MIPS_AUXSYM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000016, .hex);
pub const SHT_MIPS_OPTSYM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000017, .hex);
pub const SHT_MIPS_LOCSTR = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000018, .hex);
pub const SHT_MIPS_LINE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000019, .hex);
pub const SHT_MIPS_RFDESC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000001a, .hex);
pub const SHT_MIPS_DELTASYM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000001b, .hex);
pub const SHT_MIPS_DELTAINST = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000001c, .hex);
pub const SHT_MIPS_DELTACLASS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000001d, .hex);
pub const SHT_MIPS_DWARF = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000001e, .hex);
pub const SHT_MIPS_DELTADECL = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000001f, .hex);
pub const SHT_MIPS_SYMBOL_LIB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000020, .hex);
pub const SHT_MIPS_EVENTS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000021, .hex);
pub const SHT_MIPS_TRANSLATE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000022, .hex);
pub const SHT_MIPS_PIXIE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000023, .hex);
pub const SHT_MIPS_XLATE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000024, .hex);
pub const SHT_MIPS_XLATE_DEBUG = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000025, .hex);
pub const SHT_MIPS_WHIRL = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000026, .hex);
pub const SHT_MIPS_EH_REGION = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000027, .hex);
pub const SHT_MIPS_XLATE_OLD = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000028, .hex);
pub const SHT_MIPS_PDR_EXCEPTION = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000029, .hex);
pub const SHT_MIPS_XHASH = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000002b, .hex);
pub const SHF_MIPS_GPREL = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x10000000, .hex);
pub const SHF_MIPS_MERGE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x20000000, .hex);
pub const SHF_MIPS_ADDR = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x40000000, .hex);
pub const SHF_MIPS_STRINGS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x80000000, .hex);
pub const SHF_MIPS_NOSTRIP = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x08000000, .hex);
pub const SHF_MIPS_LOCAL = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x04000000, .hex);
pub const SHF_MIPS_NAMES = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x02000000, .hex);
pub const SHF_MIPS_NODUPE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x01000000, .hex);
...
pub const OEX_PAGE0 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x10000, .hex);
pub const OEX_SMM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x20000, .hex);
pub const OEX_FPDBUG = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x40000, .hex);
pub const OEX_PRECISEFP = OEX_FPDBUG;
pub const OEX_DISMISS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x80000, .hex);
...
pub const PT_MIPS_REGINFO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000000, .hex);
pub const PT_MIPS_RTPROC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000001, .hex);
pub const PT_MIPS_OPTIONS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000002, .hex);
pub const PT_MIPS_ABIFLAGS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000003, .hex);
pub const PF_MIPS_LOCAL = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x10000000, .hex);
pub const DT_MIPS_RLD_VERSION = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000001, .hex);
pub const DT_MIPS_TIME_STAMP = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000002, .hex);
pub const DT_MIPS_ICHECKSUM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000003, .hex);
pub const DT_MIPS_IVERSION = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000004, .hex);
pub const DT_MIPS_FLAGS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000005, .hex);
pub const DT_MIPS_BASE_ADDRESS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000006, .hex);
pub const DT_MIPS_MSYM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000007, .hex);
pub const DT_MIPS_CONFLICT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000008, .hex);
pub const DT_MIPS_LIBLIST = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000009, .hex);
pub const DT_MIPS_LOCAL_GOTNO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000000a, .hex);
pub const DT_MIPS_CONFLICTNO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000000b, .hex);
pub const DT_MIPS_LIBLISTNO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000010, .hex);
pub const DT_MIPS_SYMTABNO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000011, .hex);
pub const DT_MIPS_UNREFEXTNO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000012, .hex);
pub const DT_MIPS_GOTSYM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000013, .hex);
pub const DT_MIPS_HIPAGENO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000014, .hex);
pub const DT_MIPS_RLD_MAP = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000016, .hex);
pub const DT_MIPS_DELTA_CLASS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000017, .hex);
pub const DT_MIPS_DELTA_CLASS_NO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000018, .hex);
pub const DT_MIPS_DELTA_INSTANCE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000019, .hex);
pub const DT_MIPS_DELTA_INSTANCE_NO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000001a, .hex);
pub const DT_MIPS_DELTA_RELOC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000001b, .hex);
pub const DT_MIPS_DELTA_RELOC_NO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000001c, .hex);
pub const DT_MIPS_DELTA_SYM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000001d, .hex);
pub const DT_MIPS_DELTA_SYM_NO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000001e, .hex);
pub const DT_MIPS_DELTA_CLASSSYM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000020, .hex);
pub const DT_MIPS_DELTA_CLASSSYM_NO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000021, .hex);
pub const DT_MIPS_CXX_FLAGS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000022, .hex);
pub const DT_MIPS_PIXIE_INIT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000023, .hex);
pub const DT_MIPS_SYMBOL_LIB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000024, .hex);
pub const DT_MIPS_LOCALPAGE_GOTIDX = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000025, .hex);
pub const DT_MIPS_LOCAL_GOTIDX = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000026, .hex);
pub const DT_MIPS_HIDDEN_GOTIDX = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000027, .hex);
pub const DT_MIPS_PROTECTED_GOTIDX = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000028, .hex);
pub const DT_MIPS_OPTIONS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000029, .hex);
pub const DT_MIPS_INTERFACE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000002a, .hex);
pub const DT_MIPS_DYNSTR_ALIGN = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000002b, .hex);
pub const DT_MIPS_INTERFACE_SIZE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000002c, .hex);
pub const DT_MIPS_RLD_TEXT_RESOLVE_ADDR = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000002d, .hex);
pub const DT_MIPS_PERF_SUFFIX = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000002e, .hex);
pub const DT_MIPS_COMPACT_SIZE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x7000002f, .hex);
pub const DT_MIPS_GP_VALUE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000030, .hex);
pub const DT_MIPS_AUX_DYNAMIC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000031, .hex);
pub const DT_MIPS_PLTGOT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000032, .hex);
pub const DT_MIPS_RWPLT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000034, .hex);
pub const DT_MIPS_RLD_MAP_REL = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000035, .hex);
pub const DT_MIPS_XHASH = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000036, .hex);
...
pub const EF_PARISC_TRAPNIL = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00010000, .hex);
pub const EF_PARISC_EXT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00020000, .hex);
pub const EF_PARISC_LSB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00040000, .hex);
pub const EF_PARISC_WIDE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00080000, .hex);
pub const EF_PARISC_NO_KABP = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00100000, .hex);
pub const EF_PARISC_LAZYSWAP = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00400000, .hex);
pub const EF_PARISC_ARCH = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0000ffff, .hex);
pub const EFA_PARISC_1_0 = @as(c_int, 0x020b);
pub const EFA_PARISC_1_1 = @as(c_int, 0x0210);
pub const EFA_PARISC_2_0 = @as(c_int, 0x0214);
pub const SHN_PARISC_ANSI_COMMON = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff00, .hex);
pub const SHN_PARISC_HUGE_COMMON = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff01, .hex);
pub const SHT_PARISC_EXT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000000, .hex);
pub const SHT_PARISC_UNWIND = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000001, .hex);
pub const SHT_PARISC_DOC = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000002, .hex);
pub const SHF_PARISC_SHORT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x20000000, .hex);
pub const SHF_PARISC_HUGE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x40000000, .hex);
pub const SHF_PARISC_SBP = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x80000000, .hex);
...
pub const PT_PARISC_ARCHEXT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000000, .hex);
pub const PT_PARISC_UNWIND = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000001, .hex);
pub const PF_PARISC_SBP = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x08000000, .hex);
pub const PF_HP_PAGE_SIZE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00100000, .hex);
pub const PF_HP_FAR_SHARED = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00200000, .hex);
pub const PF_HP_NEAR_SHARED = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00400000, .hex);
pub const PF_HP_CODE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x01000000, .hex);
pub const PF_HP_MODIFY = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x02000000, .hex);
pub const PF_HP_LAZYSWAP = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x04000000, .hex);
pub const PF_HP_SBP = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x08000000, .hex);
pub const EF_ALPHA_32BIT = @as(c_int, 1);
pub const EF_ALPHA_CANRELAX = @as(c_int, 2);
pub const SHT_ALPHA_DEBUG = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000001, .hex);
pub const SHT_ALPHA_REGINFO = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000002, .hex);
pub const SHF_ALPHA_GPREL = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x10000000, .hex);
...
pub const EF_PPC_EMB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x80000000, .hex);
pub const EF_PPC_RELOCATABLE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00010000, .hex);
pub const EF_PPC_RELOCATABLE_LIB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00008000, .hex);
...
pub const EF_ARM_EABIMASK = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xFF000000, .hex);
pub const EF_ARM_BE8 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00800000, .hex);
pub const EF_ARM_LE8 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x00400000, .hex);
...
pub const EF_ARM_EABI_VER1 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x01000000, .hex);
pub const EF_ARM_EABI_VER2 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x02000000, .hex);
pub const EF_ARM_EABI_VER3 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x03000000, .hex);
pub const EF_ARM_EABI_VER4 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x04000000, .hex);
pub const EF_ARM_EABI_VER5 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x05000000, .hex);
pub const STT_ARM_TFUNC = STT_LOPROC;
pub const STT_ARM_16BIT = STT_HIPROC;
pub const SHF_ARM_ENTRYSECT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x10000000, .hex);
pub const SHF_ARM_COMDEF = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x80000000, .hex);
pub const PF_ARM_SB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x10000000, .hex);
pub const PF_ARM_PI = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x20000000, .hex);
pub const PF_ARM_ABS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x40000000, .hex);
...
pub const EF_CSKY_ABIMASK = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xF0000000, .hex);
pub const EF_CSKY_OTHER = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0FFF0000, .hex);
pub const EF_CSKY_PROCESSOR = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x0000FFFF, .hex);
pub const EF_CSKY_ABIV1 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x10000000, .hex);
pub const EF_CSKY_ABIV2 = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x20000000, .hex);
...
pub const EF_IA_64_ARCH = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0xff000000, .hex);
...
pub const PF_IA_64_NORECOV = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x80000000, .hex);
pub const SHT_IA_64_EXT = SHT_LOPROC + @as(c_int, 0);
pub const SHT_IA_64_UNWIND = SHT_LOPROC + @as(c_int, 1);
pub const SHF_IA_64_SHORT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x10000000, .hex);
pub const SHF_IA_64_NORECOV = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x20000000, .hex);
...
pub const SHT_X86_64_UNWIND = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000001, .hex);
...
pub const DT_NIOS2_GP = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x70000002, .hex);
...
pub const R_OR1K_NONE = @as(c_int, 0);
pub const R_OR1K_32 = @as(c_int, 1);
pub const R_OR1K_16 = @as(c_int, 2);
pub const R_OR1K_8 = @as(c_int, 3);
pub const R_OR1K_LO_16_IN_INSN = @as(c_int, 4);
pub const R_OR1K_HI_16_IN_INSN = @as(c_int, 5);
pub const R_OR1K_INSN_REL_26 = @as(c_int, 6);
pub const R_OR1K_GNU_VTENTRY = @as(c_int, 7);
pub const R_OR1K_GNU_VTINHERIT = @as(c_int, 8);
pub const R_OR1K_32_PCREL = @as(c_int, 9);
pub const R_OR1K_16_PCREL = @as(c_int, 10);
pub const R_OR1K_8_PCREL = @as(c_int, 11);
pub const R_OR1K_GOTPC_HI16 = @as(c_int, 12);
pub const R_OR1K_GOTPC_LO16 = @as(c_int, 13);
pub const R_OR1K_GOT16 = @as(c_int, 14);
pub const R_OR1K_PLT26 = @as(c_int, 15);
pub const R_OR1K_GOTOFF_HI16 = @as(c_int, 16);
pub const R_OR1K_GOTOFF_LO16 = @as(c_int, 17);
pub const R_OR1K_COPY = @as(c_int, 18);
pub const R_OR1K_GLOB_DAT = @as(c_int, 19);
pub const R_OR1K_JMP_SLOT = @as(c_int, 20);
pub const R_OR1K_RELATIVE = @as(c_int, 21);
pub const R_OR1K_TLS_GD_HI16 = @as(c_int, 22);
pub const R_OR1K_TLS_GD_LO16 = @as(c_int, 23);
pub const R_OR1K_TLS_LDM_HI16 = @as(c_int, 24);
pub const R_OR1K_TLS_LDM_LO16 = @as(c_int, 25);
pub const R_OR1K_TLS_LDO_HI16 = @as(c_int, 26);
pub const R_OR1K_TLS_LDO_LO16 = @as(c_int, 27);
pub const R_OR1K_TLS_IE_HI16 = @as(c_int, 28);
pub const R_OR1K_TLS_IE_LO16 = @as(c_int, 29);
pub const R_OR1K_TLS_LE_HI16 = @as(c_int, 30);
pub const R_OR1K_TLS_LE_LO16 = @as(c_int, 31);
pub const R_OR1K_TLS_TPOFF = @as(c_int, 32);
pub const R_OR1K_TLS_DTPOFF = @as(c_int, 33);
pub const R_OR1K_TLS_DTPMOD = @as(c_int, 34);
